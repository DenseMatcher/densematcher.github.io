// // Function to load videos or images into placeholders
// function loadContent(humanContent1, humanContent2, robotContent, caption, isImage = false) {
//     const humanVideoPlaceholder1 = document.getElementById('human-video-placeholder-1');
//     const humanVideoPlaceholder2 = document.getElementById('human-video-placeholder-2');
...
//     humanVideoPlaceholder1.innerHTML = '';
//     humanVideoPlaceholder2.innerHTML = '';
//     robotVideoPlaceholder.innerHTML = '';
  
//     if (isImage) {
//       const templateLabel = document.createElement('h6');
//       templateLabel.textContent = 'Template';
//       humanVideoPlaceholder1.appendChild(templateLabel);
    
//       // Create and append human images
//       const humanImage1 = document.createElement('img');
//       humanImage1.setAttribute('src', humanContent1);
//       humanImage1.setAttribute('width', 'auto');
//       humanVideoPlaceholder1.appendChild(humanImage1);

//       const targetLabel = document.createElement('h6');
//       targetLabel.textContent = 'Target';
//       humanVideoPlaceholder2.appendChild(targetLabel);
    
//       const humanImage2 = document.createElement('img');
//       humanImage2.setAttribute('src', humanContent2);
//       humanImage2.setAttribute('width', 'auto');
//       humanVideoPlaceholder2.appendChild(humanImage2);
...
//     } else {
//       // Create and append human videos
...
//       humanVideoPlaceholder1.appendChild(humanVideo1);
  
//         // Check if humanContent2 is not null before creating the second human video
...
//             humanVideoPlaceholder2.appendChild(humanVideo2);
//         }
